...
<div class="pys-box pys-box-top">
  <div class="pys-col pys-col-full">
    ...
    <ul>
     <li><h2><?php _e( 'Click for help: <a href="http://www.pixelyoursite.com/facebook-pixel-dynamic-events" target="_blank">How to use Dynamic Events - Step by Step Guide</a>', 'pys' ); ?></h2></li>
    </ul>
  </div>
</div>