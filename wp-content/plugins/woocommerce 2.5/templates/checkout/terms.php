...
<div>因應台灣現行電子支付法規，與提升用戶付款的安全性，使用歐付寶付費時須同時註冊為歐付寶的會員以確認身份（若已有歐付寶會員，可直接登入付費）。若沒有歐付寶會員，可以依照下列的付款步驟，在點選本頁的「下單購買」後：</div>
<img src="http://lodrorinchen.org/wp-content/uploads/2016/12/intro2.png">